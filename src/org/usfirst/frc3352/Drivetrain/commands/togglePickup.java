...
public class  togglePickup extends Command {
    ...
    protected void execute() {
        if(RobotMap.pickupState){
            Robot.pickupSolenoid.up();
            RobotMap.pickupState = false;
        }else{
            Robot.pickupSolenoid.down();
            RobotMap.pickupState = true;
        }
        isFinished = true;
    }
